...
class Params:
    def __init__(self):
        ...
        self.dropout = 0.25
        self.batch_size = 48
        self.block_size = self.batch_size * 4
        self.vocab_size = 0
...
class MultiHeadAttention(nn.Module):
    ...
    def __init__(self, num_heads, head_size, params):
        super().__init__()
        self.heads = nn.ModuleList([Head(head_size, params=params) for _ in range(num_heads)])
...
class Block(nn.Module):
    ...
    def __init__(self, n_embd, n_head, params):
        ...
        self.sa = MultiHeadAttention(n_head, head_size, params=params)
        self.ffwd = FeedFoward(n_embd,params=params)
...
class GPTLanguageModel(nn.Module):
    def __init__(self, params, compression_rate=2,  max_memory_size=1024):
        super().__init__()
        ...
        self.with_memory = params.with_memory
    ...
    def forward_normal(self, idx, targets=None):
        ...
        pos_emb = self.position_embedding_table(torch.arange(T, device=idx.device))  # (T,C) device = device
