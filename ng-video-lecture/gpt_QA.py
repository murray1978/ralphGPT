# copy of GPT/py, but adding custom dataset for query, response pairs generated
# via shakespare.tx file, with help from chatGPT.4o
# another idea is to have the AI always in learn mode monitoring the loss value,
# adding any user conversation and its response to the model.
